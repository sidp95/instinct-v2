import{d4 as t,d5 as a,eQ as s,ds as o}from"./index-BZUZJG0z.js";import{n as c}from"./ScreenLayout-DIdy7nhJ-CtKEKsly.js";import{c as d}from"./createLucideIcon-B72mi0g_.js";import"./ModalHeader-D5psNgrf-BlEKM6aB.js";import"./Screen-q8npRQhQ-DadJ2eBF.js";import"./index-Dq_xe9dz-CmgW7sSb.js";/**
...
Continue to sign with Ledger`})=>t.jsx(c,{title:i,subtitle:t.jsx(m,{children:r}),primaryCta:{label:"Continue with Ledger",onClick:e},secondaryCta:{label:"Continue without Ledger",onClick:n},watermark:!0,children:t.jsxs(u,{children:[t.jsx(s,{style:{width:"48px",height:"48px"}}),t.jsx(h,{strokeWidth:2,color:"var(--privy-color-icon-subtle)",width:22,height:22}),t.jsx(L,{style:{width:"48px",height:"48px"}})]})});function p(){let{data:e,setModalData:n,navigate:i}=a();return t.jsx(g,{onContinueWithLedger:function(){n({...e,login:{...e==null?void 0:e.login,isSigningInWithLedgerSolana:!0}}),i("ConnectionStatusScreen")},onContinueWithoutLedger:function(){n({...e,login:{...e==null?void 0:e.login,isSigningInWithLedgerSolana:!1}}),i("ConnectionStatusScreen")}})}const S={component:p};let u=o.div`
  display: flex;
  align-items: center;
