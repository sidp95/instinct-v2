...
function twistedEdwards(curveDef) {
  ...
  class Point2 {
    ...
    static fromAffine(p) {
      ...
      aCoordinate("x", x);
      aCoordinate("y", y);
      return new Point2(x, y, _1n, modP2(x * y));
    }
    ...
    add(other) {
      ...
      if (a === BigInt(-1)) {
        ...
        if (F2 === _0n)
          return this.double();
        const C2 = modP2(Z1 * _2n * T2);
        const D2 = modP2(T1 * _2n * Z2);
        const E2 = D2 + C2;
        const G3 = B2 + A2;
        const H2 = D2 - C2;
  ...
  Point2.BASE = new Point2(CURVE.Gx, CURVE.Gy, _1n, modP2(CURVE.Gx * CURVE.Gy));
  Point2.ZERO = new Point2(_0n, _1n, _1n, _0n);
...
*/
//# sourceMappingURL=chunk-AUWC7W23.js.map
