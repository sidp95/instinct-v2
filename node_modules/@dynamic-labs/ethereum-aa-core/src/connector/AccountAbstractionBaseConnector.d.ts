...
export declare abstract class AccountAbstractionBaseConnector extends WalletConnectorBase<typeof EthereumWallet> {
    ...
    getSigner(): Promise<{
        ...
        prepareAuthorization: (parameters: import("viem/_types/actions/wallet/prepareAuthorization").PrepareAuthorizationParameters<Account>) => Promise<import("viem/_types/actions/wallet/prepareAuthorization").PrepareAuthorizationReturnType>;
        ...
        signAuthorization: (parameters: import("viem/_types/actions/wallet/signAuthorization").SignAuthorizationParameters<Account>) => Promise<import("viem/_types/actions/wallet/signAuthorization").SignAuthorizationReturnType>;
