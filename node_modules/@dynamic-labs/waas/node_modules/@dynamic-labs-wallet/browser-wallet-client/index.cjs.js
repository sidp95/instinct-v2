...
class IframeManager {
   ...
   */ async initializeMessageTransport() {
        ...
        // Notify iframe that secureStorage is available
   ...
   */ async handleGetClientKeyShare(request) {
        ...
        const keyShares = await this.secureStorage.getClientKeyShare(request.chainName, request.accountAddress);
        return {
            keyShares
        };
    }
   ...
   */ async handleSetClientKeyShare(request) {
        ...
        await this.secureStorage.setClientKeyShare(request.chainName, request.accountAddress, request.keyShares);
    }
    /**
   ...
   */ async notifySecureStorageAvailable() {
        ...
        // Optional chaining handles the case where sendSecureStorageConfig doesn't exist
        // If it exists and throws, we let the error propagate
