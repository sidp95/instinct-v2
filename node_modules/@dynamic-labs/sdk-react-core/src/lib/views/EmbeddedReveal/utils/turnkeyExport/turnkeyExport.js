...
const handleExportInitCheck = ({ user, wallet, }) => {
    ...
    const turnkeyHDWalletId = (_c = walletProperties === null || walletProperties === void 0 ? void 0 : walletProperties.turnkeyHDWalletId) !== null && _c !== void 0 ? _c : undefined;
    const privateKeyId = (_d = walletProperties === null || walletProperties === void 0 ? void 0 : walletProperties.turnkeyPrivateKeyId) !== null && _d !== void 0 ? _d : undefined;
    const organizationId = (_e = walletProperties === null || walletProperties === void 0 ? void 0 : walletProperties.turnkeySubOrganizationId) !== null && _e !== void 0 ? _e : undefined;
    if (!organizationId ||
...
const exportCredential = (_d) => __awaiter(void 0, [_d], void 0, function* ({ user, wallet, environmentId, address, }) {
    ...
    if (activityStatus === 'ACTIVITY_STATUS_COMPLETED') {
        exportBundle = extractExportBundle({
            ...
            address,
            privateKeyId: privateKeyId !== null && privateKeyId !== void 0 ? privateKeyId : undefined,
        });
    }
    else {
