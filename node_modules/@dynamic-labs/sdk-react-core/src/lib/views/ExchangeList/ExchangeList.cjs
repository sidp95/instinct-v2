...
const ExchangeList = ({ onSelectExchange, showDefaultFooter, scrollContainerClassName, }) => {
    ...
    const searchContainer = !projectSettings ? (jsxRuntime.jsx(Skeleton.Skeleton, { className: 'exchange-list__search-skeleton' })) : (jsxRuntime.jsx("div", { className: classNames.classNames('exchange-list__search-container', {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [searchContainer, Boolean(error) && (jsxRuntime.jsx(ErrorContainer.ErrorContainer, { className: 'exchange-list__error-container', withIcon: false, children: error })), jsxRuntime.jsx("div", { className: classNames.classNames('exchange-list__scroll-container', scrollContainerClassName, {
                ...
                }), "data-testid": 'exchange-list-scroll-container', ref: exchangeListScrollRef, onScroll: handleScroll, children: !projectSettings ? (jsxRuntime.jsx(Skeleton.Skeleton, { count: 10, className: 'exchange-list__tile-skeleton' })) : (
