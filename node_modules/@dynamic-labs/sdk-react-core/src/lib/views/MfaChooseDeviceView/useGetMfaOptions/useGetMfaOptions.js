...
import { useGetUserMfaMethods } from '../../../utils/hooks/useGetUserMfaMethods/useGetUserMfaMethods.js';
...
const useGetMfaOptions = (isInitialSetup) => {
    ...
    return useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const showTotpOption = isInitialSetup
            ? isMfaMethodEnabled(MFADeviceType.Totp)
            : registeredMfaMethods.devices.length > 0;
        const showPasskeyOption = isInitialSetup
            ? isMfaMethodEnabled(MFADeviceType.Passkey)
...
export { BACKUP_CODE_OPTION, PASSKEY_OPTION, TOTP_OPTION, useGetMfaOptions };
