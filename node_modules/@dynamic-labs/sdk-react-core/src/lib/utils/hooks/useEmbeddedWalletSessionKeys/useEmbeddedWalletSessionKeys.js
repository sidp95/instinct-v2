...
import { StorageService, InvalidEmbeddedWalletSessionKeyError, tracing } from '@dynamic-labs/utils';
...
const useEmbeddedWalletSessionKeys = ({ environmentId, projectSettings, }) => {
    ...
    const getDecodedSessionKeys = useCallback(() => {
    ...
    const registerHelper = useCallback((_a) => __awaiter(void 0, [_a], void 0, function* ({ walletId, environmentId, privateKey, privateKeyJwk, publicKey, prevSessionKeySignature, user, }) {
        let resp;
     ...
     */
    const registerEmbeddedWalletSessionKey = useCallback((_b) => __awaiter(void 0, [_b], void 0, function* ({ ignoreRestore = false, walletId, }) {
        if (!user) {
    ...
    }), [environmentId, getDecodedSessionKeys, registerHelper, user]);
    ...
    const shouldRegisterSessionKeysOnSignin = useCallback(() => true, []);
    ...
    }), [getDecodedSessionKeys, user === null || user === void 0 ? void 0 : user.sessionId]);
