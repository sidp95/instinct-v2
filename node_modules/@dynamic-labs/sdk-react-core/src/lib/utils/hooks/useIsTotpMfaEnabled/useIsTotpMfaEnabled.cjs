...
const useIsTotpMfaEnabled = () => {
    ...
    return Boolean((_c = (_b = (_a = projectSettings === null || projectSettings === void 0 ? void 0 : projectSettings.security) === null || _a === void 0 ? void 0 : _a.mfa) === null || _b === void 0 ? void 0 : _b.methods) === null || _c === void 0 ? void 0 : _c.find((method) => method.type === sdkApiCore.MFADeviceType.Totp && method.enabled));
};
