...
import { useInitStatus } from '../../../client/extension/initStatus/useInitStatus/useInitStatus.js';

const useGlobalLoading = ({ connectedInfo, connectedWallets, projectSettings, primaryWalletId, primaryWallet, user, walletBook, enableInstrumentation, appName, environmentId, nonce, }) => {
    var _a;
