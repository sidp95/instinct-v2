...
var useInitStatus = require('../../../client/extension/initStatus/useInitStatus/useInitStatus.cjs');

const useGlobalLoading = ({ connectedInfo, connectedWallets, projectSettings, primaryWalletId, primaryWallet, user, walletBook: walletBook$1, enableInstrumentation, appName, environmentId, nonce, }) => {
    var _a;
    ...
    const initStatus = useInitStatus.useInitStatus();
    ...
    const isJavascriptSDKLoading = initStatus === 'uninitialized' || initStatus === 'in-progress';
    ...
    logger.logger.logVerboseTroubleshootingMessage('[useGlobalLoading] SDK loading', {
        ...
        isValidatingSession,
        isWalletBookLoading,
        javascriptSDKInitStatus: initStatus,
    });
