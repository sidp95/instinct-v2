...
import { isDynamicWaasConnector, isEmbeddedConnector } from '@dynamic-labs/wallet-connector-core';
...
const Wallet = ({ wallet, ens, clickable }) => {
    ...
    const isWaasWallet = isDynamicWaasConnector(connector);
    const addressTypeLabel = getWaasAddressTypeLabel(wallet.chain || connector.connectedChain, isWaasWallet, address);
    ...
    return (jsxs("div", { className: 'wallet__container', "data-testid": 'wallet', children: [jsxs("div", { className: classNames('wallet__row', {
                ...
                }), onClick: clickable ? handleSwitchWallet : undefined, children: [jsx("div", { className: 'wallet__icon-container', children: jsx(AuthProviderIcon, { iconSize: iconSize, wallet: wallet, showNetworkIcon: true }) }), jsx("div", { style: { display: 'flex', flex: 1, flexDirection: 'column' }, children: (ens === null || ens === void 0 ? void 0 : ens.name) ? (jsxs(Fragment, { children: [jsx(Typography, { className: 'wallet__ens-name', variant: 'body_small', color: 'primary', truncate: true, children: ens === null || ens === void 0 ? void 0 : ens.name }), jsx("div", { className: 'wallet__row__separator' }), addressTypeLabel && (jsx(Typography, { variant: 'body_mini', color: 'secondary', children: addressTypeLabel })), jsx(Typography, { variant: 'body_mini', color: 'secondary', children: shortenWalletAddress(address) })] })) : (jsxs(Fragment, { children: [addressTypeLabel && (jsx(Typography, { variant: 'body_mini', color: 'secondary', children: addressTypeLabel })), jsx(Typography, { variant: 'body_small', color: 'primary', children: shortenWalletAddress(address) })] })) })] }), jsx("div", { className: 'wallet__row__separator wallet__row__menu__separator ' }), jsx(DotsMenu, { "data-testid": 'dots-menu', options: options, buttonClassName: 'wallet__menu', direction: 'left' })] }));
};
