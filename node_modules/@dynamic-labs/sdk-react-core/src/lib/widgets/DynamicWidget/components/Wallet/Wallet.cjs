...
const Wallet = ({ wallet, ens, clickable }) => {
    ...
    const isWaasWallet = walletConnectorCore.isDynamicWaasConnector(connector);
    const addressTypeLabel = getWaasAddressTypeLabel.getWaasAddressTypeLabel(wallet.chain || connector.connectedChain, isWaasWallet, address);
    ...
    return (jsxRuntime.jsxs("div", { className: 'wallet__container', "data-testid": 'wallet', children: [jsxRuntime.jsxs("div", { className: classNames.classNames('wallet__row', {
                ...
                }), onClick: clickable ? handleSwitchWallet : undefined, children: [jsxRuntime.jsx("div", { className: 'wallet__icon-container', children: jsxRuntime.jsx(AuthProviderIcon.AuthProviderIcon, { iconSize: iconSize, wallet: wallet, showNetworkIcon: true }) }), jsxRuntime.jsx("div", { style: { display: 'flex', flex: 1, flexDirection: 'column' }, children: (ens === null || ens === void 0 ? void 0 : ens.name) ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(Typography.Typography, { className: 'wallet__ens-name', variant: 'body_small', color: 'primary', truncate: true, children: ens === null || ens === void 0 ? void 0 : ens.name }), jsxRuntime.jsx("div", { className: 'wallet__row__separator' }), addressTypeLabel && (jsxRuntime.jsx(Typography.Typography, { variant: 'body_mini', color: 'secondary', children: addressTypeLabel })), jsxRuntime.jsx(Typography.Typography, { variant: 'body_mini', color: 'secondary', children: shortenWalletAddress.shortenWalletAddress(address) })] })) : (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [addressTypeLabel && (jsxRuntime.jsx(Typography.Typography, { variant: 'body_mini', color: 'secondary', children: addressTypeLabel })), jsxRuntime.jsx(Typography.Typography, { variant: 'body_small', color: 'primary', children: shortenWalletAddress.shortenWalletAddress(address) })] })) })] }), jsxRuntime.jsx("div", { className: 'wallet__row__separator wallet__row__menu__separator ' }), jsxRuntime.jsx(DotsMenu.DotsMenu, { "data-testid": 'dots-menu', options: options, buttonClassName: 'wallet__menu', direction: 'left' })] }));
};
