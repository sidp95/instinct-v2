...
const createHandleRevoke = (revokeDelegation) => (walletWithStatus) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        logger.warn('Error revoking delegation:', error);
        return false;
    }
});
const createHandleDelegate = (delegateKeyShares) => (walletWithStatus) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        logger.warn('Error delegating key shares:', error);
        return false;
    }
});
const createHandleWalletStatusChange = (handleRevoke, handleDelegate) => (wallet) => __awaiter(void 0, void 0, void 0, function* () {
...
const createHandleRevokeAll = (handleRevoke, walletsWithStatus) => () => __awaiter(void 0, void 0, void 0, function* () {
...
const WalletsDelegatedSettingsView = ({ name }) => {
    ...
    const { revokeDelegation, delegateKeyShares } = useWalletDelegation();
