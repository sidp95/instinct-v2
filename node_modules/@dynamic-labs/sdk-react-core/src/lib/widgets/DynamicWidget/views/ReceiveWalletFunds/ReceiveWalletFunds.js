...
import { isFiatToken, isFiatOrStablecoin } from './utils/isFiatToken/isFiatToken.js';
...
import { createFundingButtons } from './utils/createFundingButtons/createFundingButtons.js';
import { parseQuickSuggestions } from './utils/parseQuickSuggestions/parseQuickSuggestions.js';
import { useFundingHandlers } from './utils/useFundingHandlers/useFundingHandlers.js';
import { useFundingDisplay } from './utils/useFundingDisplay/useFundingDisplay.js';
...
const ReceiveWalletFunds = ({ amount: initialAmount, token: initialTokenRaw, wallet, exchange, fundingWithExchange = false, accounts, quickSuggestions = defaultQuickSuggestions, network, destinationAddress, onBack, hideBackButton = false, }) => {
    ...
    const { secondaryDisplay, grayOutSecondaryDisplay, inputSymbolProp } = useFundingDisplay({
        primaryData,
        secondaryData,
    });
    const quickSuggestionsWithTokenTemp = Array.isArray(quickSuggestions)
        ...
        : quickSuggestions;
    const { quickSuggestionsWithToken, quickSuggestionsParsed } = parseQuickSuggestions(quickSuggestions, (value) => respectsMinimum({ token: quickSuggestionsWithTokenTemp.token, value: value.toString() }, minimum, exchangeRates));
    ...
    const { handleSelectToken, handleQuickSuggestion, closeTokenSelect, switchPrimaryAndSecondary, } = useFundingHandlers({
        fiatAmount,
        inputEmitter,
                    ...
                    'fund-from-wallet__token-select--open': showTokenSelect,
                        ...
                        : t('dyn_wallet_funding.from_wallet.amount_input.title') }) }), jsxs("div", { className: 'fund-from-wallet__content', children: [jsxs("div", { className: 'fund-from-wallet__content__amount-container', children: [minimum && (jsx(Typography, { color: 'error-1', className: classNames('fund-from-wallet__content__amount-container__minimum-error', {
                                    ...
                                    'fund-from-wallet__content__wallet-card__balance--disable-select': disableTokenSelect,
                                                    ...
                                                    value: (_g = primaryBalance.value) !== null && _g !== void 0 ? _g : UNAVAILABLE_VALUE,
                                                    ...
                                                    value: (_h = secondaryBalance.value) !== null && _h !== void 0 ? _h : UNAVAILABLE_VALUE,
