...
class ZeroDevConnector extends ethereumAaCore.AccountAbstractionBaseConnector {
    constructor(opts) {
        ...
        this.bundlerProvider =
            (_g = (_f = (_e = opts.apiProviders.zerodev) === null || _e === void 0 ? void 0 : _e.zerodevBundlerProvider) !== null && _f !== void 0 ? _f : ZeroDevConnector.bundlerProviderDefault) !== null && _g !== void 0 ? _g : sdkApiCore.ZerodevBundlerProvider.Pimlico;
        this.bundlerRpc =
    ...
    warnIfProjectChainNotEnabled(chainId) {
        return _tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!isProjectChainEnabled) {
                logger.logger.error(`Please make sure to enable (${chainIdToCheck}) in the Dynamic dashboard (https://app.dynamic.xyz/dashboard/chains-and-networks#evm).`);
            }
        });
    }
    /**
